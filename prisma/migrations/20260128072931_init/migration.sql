...
-- CreateTable
CREATE TABLE "fac_catalogos_servicios" (
    "id" TEXT NOT NULL,
    "codigo" VARCHAR(20) NOT NULL,
    "nombre" VARCHAR(255) NOT NULL,
    "descripcion" TEXT,
    "precioBase" DECIMAL(12,3) DEFAULT 0.00,
    "tarifaVariable" BOOLEAN NOT NULL DEFAULT false,
    "activo" BOOLEAN NOT NULL DEFAULT true,
    "userCreateId" TEXT NOT NULL,
    "userUpdateId" TEXT,
    "fechaCreacion" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "fac_catalogos_servicios_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "fac_ventas_servicios" (
    "id" TEXT NOT NULL,
    "clienteId" TEXT NOT NULL,
    "tipoTransaccion" VARCHAR(20) NOT NULL,
    "numeroTransaccion" VARCHAR(50) NOT NULL,
    "fecha" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "total" DECIMAL(10,3) NOT NULL DEFAULT 0.00,
    "observaciones" TEXT,
    ...
    CONSTRAINT "fac_ventas_servicios_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "fac_ventas_servicios_detalles" (
    "id" TEXT NOT NULL,
    "ventaServicioId" TEXT NOT NULL,
    "catalogoServicioId" TEXT NOT NULL,
    "descripcion" TEXT,
    "cantidad" DECIMAL(65,30) NOT NULL DEFAULT 1,
    "precioUnitario" DECIMAL(10,3) NOT NULL DEFAULT 0.00,
    "precioCatalogo" DECIMAL(10,3) NOT NULL DEFAULT 0.00,
    "subtotal" DECIMAL(10,3) NOT NULL DEFAULT 0.00,
    "descuento" DECIMAL(10,3) DEFAULT 0.00,
    "codigoActividadSin" VARCHAR(20),
    "userCreateId" TEXT NOT NULL,
    "userUpdateId" TEXT,
    "fechaCreacion" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "fechaActualizacion" TIMESTAMP(3),

    CONSTRAINT "fac_ventas_servicios_detalles_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "fac_ventas_servicios_numeroTransaccion_key" ON "fac_ventas_servicios"("numeroTransaccion");
...
-- AddForeignKey
ALTER TABLE "core_derivaciones_servicio" ADD CONSTRAINT "core_derivaciones_servicio_derivacionPadreId_fkey" FOREIGN KEY ("derivacionPadreId") REFERENCES "core_derivaciones_servicio"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "fac_ventas_servicios" ADD CONSTRAINT "fac_ventas_servicios_clienteId_fkey" FOREIGN KEY ("clienteId") REFERENCES "cat_clientes"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fac_ventas_servicios_detalles" ADD CONSTRAINT "fac_ventas_servicios_detalles_ventaServicioId_fkey" FOREIGN KEY ("ventaServicioId") REFERENCES "fac_ventas_servicios"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "fac_ventas_servicios_detalles" ADD CONSTRAINT "fac_ventas_servicios_detalles_catalogoServicioId_fkey" FOREIGN KEY ("catalogoServicioId") REFERENCES "fac_catalogos_servicios"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
