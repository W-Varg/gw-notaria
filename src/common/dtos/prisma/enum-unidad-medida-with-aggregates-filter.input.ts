...
import { NestedEnumUnidadMedidaWithAggregatesFilter } from './nested-enum-unidad-medida-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumUnidadMedidaFilter } from './nested-enum-unidad-medida-filter.input';
import { IsArray, IsEnum } from 'class-validator';

export class EnumUnidadMedidaWithAggregatesFilter {
  @Expose()
