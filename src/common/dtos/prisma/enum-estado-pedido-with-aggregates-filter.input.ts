...
import { NestedEnumEstadoPedidoWithAggregatesFilter } from './nested-enum-estado-pedido-with-aggregates-filter.input';
import { NestedIntFilter } from './nested-int-filter.input';
import { NestedEnumEstadoPedidoFilter } from './nested-enum-estado-pedido-filter.input';
import { IsArray, IsEnum } from 'class-validator';

export class EnumEstadoPedidoWithAggregatesFilter {
  @Expose()
