...
Sistema backend desarrollado para una **notaría** que ofrece múltiples **servicios notariales** (trámites) a sus clientes. El sistema gestiona el ciclo de vida completo de cada servicio desde su inicio hasta su finalización, permitiendo:
